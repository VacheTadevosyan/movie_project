...
class _MovieRemote implements MovieRemote {
  _MovieRemote(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<MovieResultsResponse> getPopularMovie(
    ...
    final _options = _setStreamType<MovieResultsResponse>(
