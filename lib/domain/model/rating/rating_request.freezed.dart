...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingRequest&&(identical(other.value, value) || other.value == value));
}
...
@override
String toString() {
  return 'RatingRequest(value: $value)';
}
...
class _RatingRequest implements RatingRequest {
  const _RatingRequest({required this.value});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RatingRequest&&(identical(other.value, value) || other.value == value));
}
